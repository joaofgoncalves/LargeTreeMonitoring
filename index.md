...
![](reference/figures/LTM_logo-small-v1.png)

**Large Tree Monitoring\]** (LTM) is an R-based project designed to
monitor large trees using Sentinel-2 satellite imagery and Google Earth
Engine (GEE). The project offers tools for data acquisition,
...
- **Visualization**: Utilize LTM_plots.R to generate informative plots
  of the data and analysis results.
...
![](reference/figures/LTM_shiny_app.png)
