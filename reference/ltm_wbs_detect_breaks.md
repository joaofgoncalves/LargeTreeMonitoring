...
Applies [`wbs::wbs()`](https://rdrr.io/pkg/wbs/man/wbs.html) followed by
...
adjustment. The first selected WBS change point is used as the primary
break and is evaluated with the shared validators.
...
- num_intervals:
  ...
  Integer number of random intervals passed to
  [`wbs::wbs()`](https://rdrr.io/pkg/wbs/man/wbs.html) as
  `numIntervals`.
...
An object of class `ts_breaks_run` with method `"wbs"`. The object
